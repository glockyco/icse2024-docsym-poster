...
% \usepackage[size=a1,scale=1.5,orientation=portrait]{beamerposter} % Use the beamerposter package for laying out the poster with a portrait orientation and an a0 paper size
\usepackage[size=custom,width=61.4,height=86.1,scale=1.054,orientation=portrait]{beamerposter} % Use the beamerposter package for laying out the poster with a portrait orientation and an a0 paper size

% \usepackage[
%   % set width and height to a4 width and height + 6mm
%   width=59.4truecm, height=84.1truecm,
...
\title{\fontsize{45}{45}\selectfont{}Aiding Developer Understanding of Software Changes\\[18pt]via Symbolic Execution-based Semantic Differencing} % Poster title
...
\begin{document}
\addtobeamertemplate{block end}{}{\vspace*{.8ex}} % White space under blocks

\begin{frame}[t] % The whole poster is enclosed in one beamer frame

\begin{columns}[t] % The whole poster consists of two major columns, each of which can be subdivided further with another \begin{columns} block - the [t] argument aligns each column's content to the top

  \begin{column}{.04\textwidth}\end{column} % Empty spacer column
